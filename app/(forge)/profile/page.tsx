...
export default async function Page() {
  ...
  return (
    <main className="mb-6 px-6 text-gray-700 space-y-12">
      ...
      <section className="container space-y-2 py-3 ">
        <div className="mb-6">
          <h1 className="text-3xl sm:text-5xl font-bold">Security</h1>
      ...
      <section className="container space-y-2 py-3 ">
        ...
        <div className="flex flex-row justify-between py-6 border-t border-gray-200 rounded-3xl">
          <div>
            <p className="text-md font-medium text-gray-600">Delete Profile</p>
